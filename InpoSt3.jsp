...
<%
	//XML 데이터를 호출할 URL
	String url = "http://ws.bus.go.kr/api/rest/stationinfo/getRouteByStation?ServiceKey=6BS0pHb4y5eedo8ZQYAKYQ48Omt3cnuNJBa6w4LEB7bgXN5o7sPd8XGcj9RSXtDzdaaVnqBHkr418dG7NxqIfQ%3D%3D&arsId=02004";
...
<script>
	function refresh(){
		...
		location.href='http://localhost:8080/xmlreport/InpoSt3.jsp?size=' + sel.value;
	}
</script>
